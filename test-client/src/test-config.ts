...
export const TEST_CONFIG: TestConfig = {
  channels: {
    public: {
      id: process.env.TEST_CHANNEL_ID || 'C099184U2TU', // tbvaidatalearning.slack.com/archives/C099184U2TU
      name: process.env.TEST_CHANNEL_NAME || 'mcp_test', // Channel name from Slack
      description: 'Test channel for MCP integration testing - tbvaidatalearning workspace',
    },
  ...
  users: {
    test_user: {
      id: process.env.TEST_USER_ID || 'U08SBN9MTUG', // Working user ID from workspace
      name: 'hoaitandev',
      email: 'hoaitandev@example.com',
    },
    bot_user: {
  ...
  messages: {
    sample_thread: {
      channel_id: process.env.TEST_CHANNEL_ID || 'C099184U2TU', // Same channel for consistency
      thread_ts: process.env.TEST_THREAD_TS || '1234567890.123456', // Will be overridden by sequential tests
