...
async function testThreadResources() {
  ...
  const threadResources = allResources.filter(resource => 
    resource.uri.includes('thread') || resource.uri.includes('/threads')
  );
 ...
 */
async function runThreadResourceTests(registry: ResourceRegistry) {
  const tests = [
 ...
 */
async function testWorkspaceThreads(registry: ResourceRegistry) {
  try {
 ...
 */
async function testAdvancedThreadSearch(registry: ResourceRegistry) {
  try {
 ...
 */
async function testChannelThreads(registry: ResourceRegistry) {
  try {
 ...
 */
async function testThreadDetails(registry: ResourceRegistry) {
  try {
 ...
 */
async function testThreadReplies(registry: ResourceRegistry) {
  try {
 ...
 */
async function testParameterExtraction(registry: ResourceRegistry) {
  try {
 ...
 */
async function testErrorHandling(registry: ResourceRegistry) {
  try {
 ...
 */
async function testDynamicURIRouting(registry: ResourceRegistry) {
  try {
