...
class ThreadWorkflowHelper {
    ...
    static async getThreadMetadata(client, channelId, threadTs) {
    ...
    static async notifyStakeholders(client, channelId, threadTs, action, participants) {
...
export class ThreadWorkflowTools {
     ...
     */
    static createPromoteThreadTool() {
        return {
            name: 'promote_thread',
     ...
     */
    static createEscalateThreadTool() {
        return {
     ...
     */
    static createThreadWatcherTool() {
        return {
            name: 'watch_thread',
     ...
     */
    static createThreadMetricsTool() {
        return {
     ...
     */
    static getWorkflowToolsByCategory() {
        return {
            promotion: [
                this.createPromoteThreadTool(),
                this.createEscalateThreadTool()
...
//# sourceMappingURL=thread-workflow.js.map